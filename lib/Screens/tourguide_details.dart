      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: NetworkImage(guideDetails.image),
                    fit: BoxFit.cover)),
          ),
          const Spacer(flex: 1),
          ...
          Padding(
              ...
              child: Linkable(
                  text: guideDetails.experience,
                  maxLines: getMaxLines(guideDetails.experience))),
          const Spacer(flex: 1),
          const Text("Rating",
              style: TextStyle(fontSize: 19, fontWeight: FontWeight.bold)),
          RatingBarIndicator(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    picked == null
                        ? 'Choose a date'
                        : picked.toString().substring(0, 11),
          ...
          ElevatedButton(
              ...
              child: Text("Contact Guide",
                  style: TextStyle(
                      color: picked == null ? Colors.black45 : Colors.white))),
          const Spacer(flex: 4),
        ],
      ),
    );
